...
export function SiteFooter() {
  return (
    <footer className="mt-32 border-t border-border/60 bg-sand/30">
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-12">
        <div className="grid gap-12 md:grid-cols-3">
          <div>
            <p className="font-serif text-2xl text-earth">AstroBalance</p>
            <p className="mt-1 text-[0.65rem] uppercase tracking-[0.25em] text-dusk">
              by Victoria Storer
            </p>
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-dusk">Navigation</p>
            <ul className="mt-5 space-y-2.5 text-sm text-earth">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-dusk">Kontakt</p>
            <address className="mt-5 space-y-1 text-sm not-italic text-earth">
              <p>Victoria Storer</p>
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t border-border/60 pt-6 text-xs text-dusk md:flex-row md:items-center">
