...
function Section({ title, children, id }: { title: string; children: React.ReactNode; id: string }) {
  return (
    <section id={id} className="border-t border-border pt-12">
      <h2 className="font-serif text-3xl text-earth md:text-4xl">{title}</h2>
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-24 lg:px-12 lg:py-32">
      ...
      <nav className="mt-10 flex flex-wrap gap-x-6 gap-y-2 text-sm text-dusk">
        <a href="#impressum" className="border-b border-border hover:text-clay">Impressum</a>
        <a href="#datenschutz" className="border-b border-border hover:text-clay">Datenschutz</a>
        <a href="#agb" className="border-b border-border hover:text-clay">AGB</a>
      </nav>
      ...
      <div className="mt-16 space-y-16">
        <Section id="impressum" title="Impressum">
          ...
          <p>
            <strong className="text-earth">AstroBalance</strong><br />
            Victoria Storer<br />
          ...
          <h3 className="mt-8 font-serif text-xl text-earth">Haftungsausschluss</h3>
          <p>
          ...
          <h3 className="mt-8 font-serif text-xl text-earth">Urheberrecht</h3>
          <p>
        ...
        <Section id="datenschutz" title="Datenschutzerklärung">
          <h3 className="font-serif text-xl text-earth">1. Allgemeine Hinweise</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">2. Kontaktaufnahme</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">3. Verarbeitung im Rahmen der Angebote</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">4. Speicherung und Löschung</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">5. Ihre Rechte</h3>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">6. Server-Logfiles</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">7. Cookies</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">8. SSL-Verschlüsselung</h3>
          <p>
        ...
        <Section id="agb" title="Allgemeine Geschäftsbedingungen">
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">1. Geltungsbereich</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">2. Leistungsbeschreibung</h3>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">3. Eigenverantwortung</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">4. Terminvereinbarung und Stornierung</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">5. Schriftliche Leistungen</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">6. Honorar und Zahlungsbedingungen</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">7. Haftungsausschluss</h3>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">8. Vertraulichkeit</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">9. Urheberrecht</h3>
          <p>
          ...
          <h3 className="mt-6 font-serif text-xl text-earth">10. Gerichtsstand und anwendbares Recht</h3>
          <p>
