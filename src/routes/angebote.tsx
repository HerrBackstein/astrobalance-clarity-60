          ...
          {offers.map((o) => (
            ...
            >
              <div className="md:col-span-4">
                ...
                <h2 className="mt-5 font-serif text-3xl text-mist md:text-4xl">{o.title}</h2>
              ...
              <div className="space-y-5 md:col-span-7 md:col-start-6">
                ...
                <ul className="space-y-2.5">
                  {o.bullets.map((b) => (
                    <li key={b} className="flex items-start gap-3 text-sm font-light text-mist">
                ...
                <Link
                  to="/kontakt"
                  className="mt-4 inline-flex border-b border-clay/50 pb-1 text-sm text-mist hover:border-clay hover:text-clay"
                >
