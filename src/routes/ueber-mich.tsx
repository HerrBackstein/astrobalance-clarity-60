...
import victoria from "@/assets/mirror-6.jpg";
    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-12">
        <div className="grid gap-x-16 gap-y-12 md:grid-cols-2">
          <div>
            <h2 className="font-serif text-3xl text-mist">Astrologie als Bewusstwerdung</h2>
          ...
          <div>
            <h2 className="font-serif text-3xl text-mist">Werkzeuge für den Alltag</h2>
            <p className="mt-5 text-base font-light leading-relaxed text-dusk">
          ...
          <div>
            <h2 className="font-serif text-3xl text-mist">Tierkommunikation in Schriftform</h2>
            <p className="mt-5 text-base font-light leading-relaxed text-dusk">
          ...
          <div>
            <h2 className="font-serif text-3xl text-mist">Haltung</h2>
            <p className="mt-5 text-base font-light leading-relaxed text-dusk">
      ...
      <section className="border-t border-white/10/60 bg-black/20 py-24 text-mist">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-12">
          ...
          <Link
            to="/kontakt"
            className="mt-12 inline-flex rounded-full border border-mist/30 px-8 py-4 text-sm font-light text-mist transition hover:bg-white/5 hover:text-mist"
          >
            Kontakt aufnehmen
          </Link>
        </div>
