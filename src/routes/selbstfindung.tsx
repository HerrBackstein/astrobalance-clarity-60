  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-white/10/60">
        <div className="pointer-events-none absolute -right-40 top-0 size-[600px] rounded-full bg-clay/10 blur-[140px]" />
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-12">
        <div className="grid gap-16 lg:grid-cols-12">
          ...
          <div className="space-y-12 lg:col-span-6 lg:col-start-7">
            ...
            <div>
              <h3 className="font-serif text-2xl text-mist">Astrologie kann unterstützen bei:</h3>
              <ul className="mt-5 space-y-3 text-base font-light text-mist">
                {[
            ...
            <div>
              <h3 className="font-serif text-2xl text-mist">Wie ich arbeite</h3>
              <p className="mt-5 text-base font-light leading-relaxed text-dusk">
      ...
      <section className="border-t border-white/10/60 bg-black/15">
        <div className="mx-auto max-w-3xl px-6 py-24 text-center lg:px-12">
          ...
          <Link to="/kontakt" className="mt-10 inline-flex rounded-full bg-black/20 px-8 py-4 text-sm font-light text-mist hover:bg-white/5">
            Beratung anfragen
          </Link>
        </div>
      </section>
